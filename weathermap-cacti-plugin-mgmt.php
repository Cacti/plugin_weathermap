<?php
    ...
    {
        global $colors,$WEATHERMAP_VERSION;
        print '<br />';
        ...
        if ( is_array( $queryrows ) ) {
            ...
            foreach ( $queryrows as $map ) {
                ...
                if ( $map[ 'warncount' ] > 0 ) {
                    ...
                    print '<a href="../../utilities.php?tail_lines=500&message_type=2&action=view_logfile&filter=' . urlencode( $map[ 'configfile' ] ) . '" title="Check cacti.log for this map"><img border=0 src=".'.$config[ 'url_path' ].'/images/exclamation.png" title="' . $map[ 'warncount' ] . ' warnings last time this map was run. Check your logs.">' . $map[ 'warncount' ] . "</a>";
                }
                print "</td>";
